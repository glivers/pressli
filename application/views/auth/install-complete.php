...
@section('content')
        ...
        <div class="auth-card">
            ...
            <div style="display: flex; gap: var(--spacing-sm);">
                <a href="{{ Url::base() }}" class="btn btn-secondary" style="flex: 1; text-align: center; text-decoration: none;">View Site</a>
                <a href="{{ Url::link('login') }}" class="btn btn-primary" style="flex: 1; text-align: center; text-decoration: none;">Log In</a>
            </div>
        </div>
@endsection