            ...
            <div class="editor-layout">
                ...
                <div class="editor-main">
                    ...
                    <div class="permalink-wrapper">
                        ...
                        <input type="text" class="permalink-input" placeholder="page-slug">
                        <button class="permalink-edit-btn">Edit</button>
                    </div>

                    <!-- Content Editor -->
                    <div class="editor-content-wrapper">
                        <textarea class="editor-content" placeholder="Start writing your page..."></textarea>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <textarea class="form-textarea" rows="3" placeholder="Write a short excerpt for this page..."></textarea>
                        <p class="form-help">The excerpt may be displayed in search results and some page layouts.</p>
                    </div>
                </div>
                ...
                <div class="editor-sidebar">
                    ...
                    <div class="sidebar-panel">
                        <div class="panel-header">
                            <h3 class="panel-title">Page Template</h3>
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="sidebar-panel">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="form-help">Create a hierarchy of pages</p>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-panel">
                        ...
                        <div class="panel-body">
                            <input type="number" class="text-input" value="0" min="0">
                            <p class="form-help">Pages are ordered numerically, then alphabetically</p>
                        </div>
                    </div>
                </div>
            </div>
